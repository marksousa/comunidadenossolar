        ...
        <div class="card-body">
          <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
              ...
              <a class="nav-item nav-link" id="nav-filiacao-tab" data-toggle="tab" href="#nav-filiacao" role="tab" aria-controls="nav-filiacao" aria-selected="false">Filiação</a>
          ...
          <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade" id="nav-filiacao" role="tabpanel" aria-labelledby="nav-filiacao-tab">
              <div class="row py-3">
                <div class="container">
                  <div class="form-group">
                    @if(!empty($usuario->nome_mae)||!empty($usuario->nome_pai))
                      <div class="form-row">
                        {{-- nome da mae --}}
                        @if (!empty($usuario->nome_mae))
                          <div class="form-group col-md-12">
                            <label for="nome_mae"><small>Nome da Mãe</small></label>
                            <input type="text" class="form-control text-capitalize" id="nome_mae" maxlength="80" value="{{ $usuario->nome_mae }}" name="nome_mae" readonly>
                          </div>
                        @endif
                      </div> {{-- fecha form-row --}}
                      <div class="form-row">
                        {{-- nome do pai --}}
                        @if (!empty($usuario->nome_pai))
                          <div class="form-group col-md-12">
                            <label for="nome_pai"><small>Nome do Pai</small></label>
                            <input type="text" class="form-control text-capitalize" id="nome_pai" maxlength="80" value="{{ $usuario->nome_pai }}" name="nome_mae" readonly>
                          </div>
                        @endif
                      </div> {{-- fecha form-row --}}
                    @else
