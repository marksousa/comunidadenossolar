...
<head>
  ...
  <title>Nosso Lar - Comunidade Espírita - Alagoas/BR</title>
  ...
  <!-- Vendor CSS Files (herdado do template) -->
...
<body>
  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container d-flex">
      ...
      <div class="cta">
        <a href="{{ route('admin-home') }}" class="scrollto">Colaboradores</a>
      </div>
    </div>
  </section>
  ...
  <header id="header">
    <div class="container d-flex">
      ...
      <h1 class="text-light"><a href="index.html"><span>Nosso Lar</span></a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="#portfolio">Biblioteca</a></li>
          <li><a href="#team">Cursos</a></li>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container" data-aos="fade-in">
      <h1>Comunidade Espírita Nosso Lar</h1>
