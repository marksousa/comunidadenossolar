                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Complete Name') }} <span class="text-danger"><strong>*</strong></span></label>
                        ...
                        <div class="form-group row">
                          <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('CPF') }} <span class="text-danger"><strong>*</strong></span></label>
