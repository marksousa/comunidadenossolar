...
class PilarSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('pilares')->insert(['nome' => 'Doutrinário', 'areas' => 'Atendimento Fraterno, Biblioteca, Estudos, Evangelho no Lar, Evangelização infantil, Eventos, Mediúnica, Mocidade, Palestras, Recepção, Trabalhos de Caridade, Tratamento Espiritual']);
